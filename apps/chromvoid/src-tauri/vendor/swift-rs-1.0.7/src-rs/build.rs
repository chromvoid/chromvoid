    ...
    pub fn link(self) {
        ...
        for package in self.packages {
            ...
            if matches!(rust_target.os, RustTargetOS::IOS) {
                // Xcode-run SwiftPM builds in this project can access the shared cache
                // but may fail when trying to refresh remote dependencies.
                command.arg("--disable-automatic-resolution");
            }
